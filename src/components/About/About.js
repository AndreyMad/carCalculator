        ...
        <ul className={styles.list}>
          ...
          <li className={styles.item}>
            ...
            <p className={styles.about}>
              ...
              продаж автозапчастин. Ми співпрацюємо з постачальниками з Європи,
              США, Японії, Арабських Еміратів та інших. Тому при замовленні авто
              у нас Ви можете бути впевнені в тому що отримаєте якісні запасні
              частини за найкращими цінами на ринку.
            </p>
          </li>
        </ul>
      </div>
