            ...
            <ul className={style.causesList}>
              <li className={style.listItem}>
                ...
                <span className={style.listInnerItem}>
                  ...
                  митних зборів, оплати доставлення — автомобіль із США
                  обійдеться дешевше, ніж його аналог в Україні на 30-50%.
                </span>
              </li>
              <li className={style.listItem}>
                <img
              ...
              <li className={style.listItem}>
                ...
                <span className={style.listInnerItem}>
                  Купівлі авто відбувається в 2 етапи. Після виграшу на аукціоні
